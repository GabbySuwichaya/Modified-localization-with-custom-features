...
ImageMatching="ApproxMatch" # "ExhaustMatch"
...
model_file_detection="models/trained-d2-nophototourism-FP32.pth" 
model_name=${model_file_detection//"models/trained-d2-"/""}
...
suffix="$model_name"-detThr"$detThr"-max-"$detThr_method"_"$ImageMatching"_FeatMtch"$FeatMATCHER"_Mtch"$MatchThr"_Scr"$ScoreThr"_Python_3
...
#mkdir $dataset_path/"sparse-d2_net-final" 

# Step 5.
#colmap image_registrator --database_path $dataset_path/$method_name.db --input_path $dataset_path/model_$method_name/ --output_path $dataset_path/"sparse-d2_net-final"

mkdir $dataset_path/"sparse-d2_net-final-txt"
# Step 6.
